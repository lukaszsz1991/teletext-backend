...
public record HighlightlyMatchesInfo(
  HighlightlyPagination pagination,
  HighlightlyMatchInfo[] data
) {
  public record HighlightlyPagination(
    int totalCount,
    int offset,
    int limit
  ){}
  ...
  public record HighlightlyMatchInfo(
    ...
    public record HighlightlyMatchState(
      Integer clock,
      HighlightlyMatchScore score,
      String description
    ){
      public record HighlightlyMatchScore(
        String current,
        String penalties
      ){}
    }

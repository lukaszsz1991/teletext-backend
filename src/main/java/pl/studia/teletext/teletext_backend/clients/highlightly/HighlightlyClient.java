...
public class HighlightlyClient {
  ...
  public Mono<HighlightlyStandingsInfo> getStandingsInfo(FootballLeague league, int season) {
    return highlightlyWebClient
        .get()
        .uri(
            uri ->
                uri.path(BASE_PREFIX + "standings")
  ...
  public Flux<HighlightlyMatchesInfo.HighlightlyMatchInfo> getMatchesInfo(
      FootballLeague league, int season) {
  ...
  private Mono<HighlightlyMatchesInfo> fetchMatchesPage(
      FootballLeague league, int season, int offset) {
    return highlightlyWebClient
        .get()
        .uri(
            uri ->
                uri.path(BASE_PREFIX + "matches")
                    .queryParam("leagueId", league.getId())
                    .queryParam("season", season)
